    ...
    public class King : ChessFigure
    {
        ...
        public override bool Equals(object obj)
        {
            return obj is King king &&
                   base.Equals(obj) &&
                   color == king.color &&
                   ShortFigureName == king.ShortFigureName &&
                   KindOfFigure == king.KindOfFigure &&
                   ChessBoard == king.ChessBoard &&
                   HorizontalPosition == king.HorizontalPosition &&
                   VerticalPosition == king.VerticalPosition;
        }
