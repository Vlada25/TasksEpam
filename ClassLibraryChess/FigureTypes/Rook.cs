...
namespace ClassLibraryChess.FigureTypes
{
    ...
    {
        public Rook(string combination) : base(combination)
        {

        }
        public Rook(string combination, string shortFigureName, Colors color) : base(combination, shortFigureName, color)
        {
